...
class reverseLFallingBlock(object):
    ...
    def checkCollisionAtRotation(self, RotatingNumber): # True = Collison, False = No Collision
        ...
        if (RotatingNumber == 0):
            ...
            if (self.currPos2[1] - 1 < 0) or (a or b or d):
                return True
            else:
                return False
            ...
            b = self.Field.matrix[self.currPos2[0] + 1][self.currPos2[1] + 1]
            d = self.Field.matrix[self.currPos4[0] - 1][self.currPos4[1] - 1]
            if (self.currPos2[0] + 1 > 13) or (a or b or d):
                return True
            else:
                return False
            ...
            b = self.Field.matrix[self.currPos2[0] - 1][self.currPos2[1] + 1]
            d = self.Field.matrix[self.currPos4[0] + 1][self.currPos4[1] - 1]
            if (self.currPos2[1] + 1 > 18) or (a or b or d):
                return True
            else:
                return False
            ...
            b = self.Field.matrix[self.currPos2[0] - 1][self.currPos2[1] - 1]
            d = self.Field.matrix[self.currPos4[0] + 1][self.currPos4[1] + 1]
            if (self.currPos2[0] - 1 < 0) or (a or b or d):
                return True
            else:
                return False